...
export default function TableItem(
  ...
  return (
    <div className={buttonDelete ? "table__item table__item_type_user" : "table__item"}>
      ...
      <p
        className={buttonDelete ? "table__description table__description_type_user" : "table__description"}>{registration_date}</p>
      <p
        className={buttonDelete ? "table__description table__description_type_user" : "table__description"}>{rating}</p>
      {
