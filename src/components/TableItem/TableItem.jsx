...
export default function TableItem ({username, email, registration_date, rating, id, buttonDelete, deleteUser}) {
  return(
      <div className={buttonDelete? "table__item table__item_type_user" : "table__item"}>
        ...
        {
          buttonDelete? <button className="table__delete-user hover" onClick={()=> deleteUser(id)}/> : null
        }
      </div>
  )
}